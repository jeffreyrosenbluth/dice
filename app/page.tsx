        ...
        <div className="flex flex-col place-items-center">
          ...
          <div className="max-w-3xl">
            <div className="py-4">
              ...
              <div>
                <p>
                  In this game, you will start with $100 and bet on a biased
                  coin flip. The coin has a 60% chance of landing on heads. You
                  can bet on either heads or tails, wagering any amount up to
                  your current balance for each flip. This game is inspired by a
                  study from Victor Haghani and Richard Dewey.
                </p>
                ...
                <div className="list-circle list-inside ml-4 mb-4">
                  ...
                  <div>
                    Your performance will be compared to other betting
                    strategies
                  </div>
                ...
                <div className="text-blue-400 mt-2 mb-2">
                  To play choose <code className="text-white">Game</code> from
                  the <code className="text-white">Coin Flipping</code> menu.
                </div>
                {/* <Button
            ...
            <div className="py-4">
              ...
              {coinComplete ? (
                <>
                  <p>
                    Now that you have completed the Coin Flip Game, you can run
                    a simulation with a fixed betting strategy. Run a simulation
                    of the results to compare statistics of different
                    strategies. You can change the number of flips per rounds,
                    the number of simulations samples, the bias of the coin and
                    the betting rule.
                  </p>
                  <div className="text-blue-400 mt-2 mb-2">
                    To play choose{" "}
                    <code className="text-white">Simulation</code> from the{" "}
            ...
            {diceGameEnabled ? (
              <div className="py-4">
                ...
                <p>
                  In this game, you will start with $100 and roll 3 dice. Each
                  die is calibrated to represent a different investment, one the
                  S&P 500, one a venture capital investment, and one a money
                  market investment. You will also create a portfolio of these
                  investments with up to 2x levearge in the stock and venture
                  investments. The app will keep track of cummulative balance
                  for each investment and the portfolio and plot the results. It
                  will also plot the histograms of each investment compared to
                  its trure probability distrtibution.
                </p>
                <div className="text-xl font-medium mb-1 mt-4">Game Rules</div>
                <div className="list-circle list-inside ml-4">
              ...
              <>
                ...
                <div className="text-orange-400">
                  <p className="text-justify">
                    ...
                    investments: a risk-free money market instrument, the S&P
                    500, and a high-risk option like venture capital or meme
                    stocks.
                    <br />
                    <br />
